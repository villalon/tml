...
void   lanso(long, long, long, double, double, double *, double *,
	     double *[]);
void   ritvec(double, double, double *, double *, double *, double *,
	      double *, double *);
...
void ritvec(double n, double kappa, double *ritz, double *bnd, double *alf,
	    double *bet, double *w1, double *w2)

{
   long jsq, i, k, size, id, id2, tmp;
   double js, *s;
   ...
   printf("Printing n %e size %d\n", n, sizeof(n));
   write(fp_out2, (char *)&n, sizeof(n));
   printf("Printing js %e size %d\n", js, sizeof(js));
   write(fp_out2, (char *)&js, sizeof(js));
   printf("Printing kappa %e size %d\n", kappa, sizeof(kappa));
